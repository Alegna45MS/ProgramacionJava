...
public class UsoTresEnRaya {
	...
	public static void jugadorVSjugador() {
		int pos1,pos2;
		System.out.println("Jugador 1,escoge su ficha:X o O");
		String eleccion=in.nextLine();
		while(!eleccion.equals("x") && !eleccion.equals("o")){
		...
		tablero.iniciar();
		//Si el jugador 1 a escogido la X
		...
		tablero.iniciar();
		//Si el jugador 1 a escogido la O
	}else{
		while(tablero.ganaJugador1()==false && tablero.ganaJugador2()==false && tablero.quedanMovimientos()==false) {
			System.out.println("Introduzca movimiento (Jugador 1)");
			pos1=in.nextInt();
